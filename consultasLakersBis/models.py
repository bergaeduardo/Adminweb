...
class SucursalesLakers(models.Model):
    ...
    horario = models.CharField(db_column='HORARIO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lunes = models.BooleanField(db_column='LUNES', default=False, blank=True)
    martes = models.BooleanField(db_column='MARTES', default=False, blank=True)
    miercoles = models.BooleanField(db_column='MIERCOLES', default=False, blank=True)
    jueves = models.BooleanField(db_column='JUEVES', default=False, blank=True)
    viernes = models.BooleanField(db_column='VIERNES', default=False, blank=True)
    sabado = models.BooleanField(db_column='SABADO', default=False, blank=True)
    domingo = models.BooleanField(db_column='DOMINGO', default=False, blank=True)
